package com.github.anicmv.options;
...
public class CreateCommandOptions {
    ...
    @CommandLine.Option(names = {"-s", "--source"}, defaultValue = "anicmv :)", description = "Add a source tag to facilitate cross-seeding.")
    ...
    @CommandLine.Option(names = {"--publisher"}, defaultValue = "anicmv :)", description = "Add a source tag to facilitate cross-seeding.")
